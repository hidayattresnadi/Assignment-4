        ...
        <tbody>
            <?php foreach ($courses as $course): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?= site_url('academics/courses/' .  $course->id) ?>" class="btn btn-primary btn-sm">
                    ...
                    <td>
                        <a href="<?= site_url('academics/courses/edit/' .  $course->id) ?>" class="btn btn-warning btn-sm">
                    ...
                    <td>
                        <form action="<?= site_url('academics/courses/' . $course->id) ?>" method="post" class="d-inline">
                            <?= csrf_field() ?>
